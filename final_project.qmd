...
```{r}
#| label: tbl-regionsummaryworldhappiness
#| tbl-cap: "Summary Statistics for each variable, grouped based on Region, from the world happiness index data set"
#| tbl-pos: H
#| lst-label: lst-table1
#| lst-cap: "Code Chunk for Making Summary Table Based on Region Enlisted"
# 13a. Create a summary table with a caption and kable styling.
...
```
In @tbl-regionsummaryworldhappiness
